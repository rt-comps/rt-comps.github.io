...
The value initially mirrors that in cart.  The valueis alterable but any changes will not be saved to the cart until the 'Aanpassen' button.  If the dialog is closed using the 'X' then any changes will be discarded.

Items with a count > 0 are displayed in **BOLD** text.

...
// - Use PHPMailer
// ------------------------------------------------------------------------------------------------
require_once '../leerlijn/vendor/autoload.php';
...
// order    - An array of objects that each have 'prodID' & 'count' properties
// details  - The details of the orderer
// ------------------------------------------------------------------------------------------------
...
if ($ok) {
    ...
    $ok = $doc->loadHTMLFile('https://rt-comps.github.io/rt-appeltaart/ati-form/menu.html');
    libxml_clear_errors();
}
